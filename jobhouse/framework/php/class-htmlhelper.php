...
if( ! class_exists( 'avia_htmlhelper' ) )
{
     ...
     */
		...
		function page_header()
		{
			...
			$output .= '					<li><a class="thickbox" onclick="return false;" href="http://docs..at/'.avia_backend_safe_string($this->avia_superobject->base_data['prefix']).'/changelog/index.php?TB_iframe=1">Changelog</a> |</li>';
			$output .= '					<li><a target="_blank" href="http://docs..at/'.avia_backend_safe_string($this->avia_superobject->base_data['prefix']).'/documentation/">Docs</a></li>';
			$output .= '				</ul>';
