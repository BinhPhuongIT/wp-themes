...
$avia_elements[] =	array(
					...
					"desc" 		=> __("If a value is left empty or set to default then it will not be changed from the value defined in your CSS files", 'avia_framework')."<br/><br/>".
									__("<strong>Attention:</strong> This feature is in active <strong>BETA!</strong> We will constantly add new elements to customize and need your help: If you got any suggestions on what to add please <a target='_blank' href='http://www..at/support/enfold-feature-requests/'>post them here</a>"."<br/><br/>", 'avia_framework'),
					"id" 		=> "advanced_styling",
					"type" 		=> "styling_wizard",
...
$avia_elements[] =	array(
					...
					"nodescription" => true,
					"std"			=> array(
										array('social_icon'=>'twitter', 'social_icon_link'=>'http://twitter.com/'),
										array('social_icon'=>'dribbble', 'social_icon_link'=>'http://dribbble.com/'),
										),
					'subelements' 	=> array(
...
$avia_elements[] =	array(	"name" => __("Import demo files", 'avia_framework'),
							"desc" => __("If you are new to wordpress or have problems creating posts or pages that look like the <a href='http://www..at/themes/enfold/'>Theme Demo</a> you can import dummy posts and pages here that will definitely help to understand how those tasks are done.", 'avia_framework'),
							"id" => "widgetdescription",
							"std" => "",
							"slug"	=> "demo",
							"type" => "heading",
...
$avia_elements[] =	array(
					"slug"	=> "demo",
					"name" 	=> __("Import: Jobfinder Demo", 'avia_framework'),
					"desc" 	=> 	 "<p><strong>".__("What you get: <a href='http://jobhaus.tgsdemos.com/' target='_blank'>Online Demo</a>", 'avia_framework')."</strong></p>"
								...
								."<li>".__("<a href='https://wordpress.org/plugins/wp-job-manager/' target='_blank'>WP Job Manager</a> (for job listing functionality)", 'avia_framework')."</li>"
								."<li>".__("<a href='https://wordpress.org/plugins/wp-job-manager-colors/' target='_blank'>WP Job Manager Colors</a> (for job type colors)", 'avia_framework')."</li>"
								."</ul>"
